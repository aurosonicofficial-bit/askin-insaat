...
const MAPS = {
  ...
  'medya-merkezi.html': [
    ['med_eyebrow', 'span', 'Medya Merkezi'],
    ['med_h1', 'h1', 'Referanslar, fotoğraf arşivi ve kurumsal dokümanlar.'],
    ['med_lead', 'p', '2011–2025 döneminin tüm referans sunumlarına, proje fotoğraflarına ve kurumsal belgelere bu sayfadan ulaşabilirsiniz.'],
    ['med_c1_num', 'div', 'Referans Galerisi'],
    ['med_c1_h', 'h3', 'Referanslar & Projeler 2011–2025'],
    ['med_c1_p', 'p', '17 slatten oluşan tam referans arşivi — Beypazarı, çelik yapılar, havuz projeleri ve daha fazlası.'],
    ['med_c1_link', 'span', 'Galeriyi İncele →'],
    ['med_c2_num', 'div', 'Foto & Video'],
    ['med_c2_h', 'h3', 'Proje Fotoğraf Arşivi'],
    ['med_c2_p', 'p', 'Çelik villa, tek katlı yapı, Beğendik Loft ve diğer projelere ait saha ve sunum fotoğrafları.'],
    ['med_c2_link', 'span', 'Fotoğraflara Git →'],
    ['med_c3_num', 'div', 'Doküman'],
    ['med_c3_h', 'h3', 'Referans PDF Sunumu'],
    ['med_c3_p', 'p', '2011–2025 referans ve projeler kurumsal sunum dosyasını PDF olarak indirin.'],
    ['med_c3_link', 'span', 'PDF İndir →'],
    ['med_high_eyebrow', 'span', 'Referans Öne Çıkanlar'],
    ['med_high_h2', 'h2', 'Arşivden seçkiler'],
    ['med_seeall', 'a', 'Tümünü Gör'],
    ['med_p1_period', 'span', '2011–2017'],
    ['med_p1_h', 'h3', '1.350.000 m² Yerleşim Projesi'],
    ['med_p1_d', 'p', '1200 daire, 50.000 m² AVM ve sosyal tesisler.'],
    ['med_p2_loc', 'span', 'Türkiye Geneli'],
    ['med_p2_cat', 'span', 'Havuz'],
    ['med_p2_h', 'h3', 'Aşkın Havuz — 100+ Proje'],
    ['med_p2_d', 'p', 'Açık alan havuzları, peyzaj entegrasyonu ve villa havuz uygulamaları.'],
    ['med_p3_cat', 'span', 'Butik Otel'],
    ['med_p3_h', 'h3', 'Bademli–Dikili Taş Butik Otel'],
    ['med_p3_d', 'p', 'Doğayla bütünleşik taş butik otel; peyzaj ve mimari.'],
    ['btn_view_project', 'a', 'Projeyi İncele →'],
    ['med_refs_link', 'a', 'Referanslara Git →'],
  ],
  'celik-ev-modelleri.html': [
    ['cev_eyebrow', 'span', 'Prefabrik Çelik Yapı Sistemleri'],
    ['cev_h1', 'h1', 'Çelik Ev Modelleri'],
    ['cev_lead', 'p', "45 m²'den 164 m²'ye kadar tek katlı ve iki katlı çelik sistem ev modelleri."],
    ['cev_filter_all', 'button', 'Tümü (10)'],
    ['cev_filter_single', 'button', 'Tek Katlı (5)'],
    ['cev_filter_double', 'button', 'İki Katlı (5)'],
    ['cev_meta1', 'span', 'Hazır Model'],
    ['cev_meta2', 'span', 'Metrekare Aralığı'],
    ['cev_meta3_val', 'strong', 'Hızlı'],
    ['cev_meta3', 'span', 'Montaj Süresi'],
    ['cev_b1_t', 'strong', 'Ücretsiz Keşif'],
    ['cev_b1_d', 'span', 'Uzman ekibimiz sizi arar, ihtiyaçlarınızı dinler'],
    ['cev_b2_t', 'strong', 'Hızlı Montaj'],
    ['cev_b2_d', 'span', 'Fabrika üretimi ile sahada kısa sürede tamamlama'],
    ['cev_b3_t', 'strong', 'Fiyat Teklifi'],
    ['cev_b3_d', 'span', 'Modeli seçin, size özel teklif hazırlayalım'],
    ['cev_b_btn', 'a', 'Teklif Alın →'],
  ],
  'uluslararasi-vizyon.html': [
    ['ulu_eyebrow', 'span', 'Uluslararası Vizyon'],
    ['ulu_h1', 'h1', 'Türkiye ve Birleşik Krallık merkezli kurumsal görünürlük ile iş geliştirme bakışı.'],
    ['ulu_lead', 'p', 'Kurumsal temsil yapımız; proje iletişimini, yatırım görüşmelerini ve iş geliştirme temasını daha düzenli bir çerçevede yürütmeyi hedefler.'],
    ['ulu_c1_h', 'h3', 'Kurumsal Temsil'],
    ['ulu_c1_p', 'p', 'Londra adresi üzerinden uluslararası görünürlük ve iletişim çerçevesi.'],
    ['ulu_c2_h', 'h3', 'Saha ve Operasyon'],
    ['ulu_c2_p', 'p', 'İzmir / Dikili merkezli saha takibi, üretim ve uygulama odağı.'],
    ['ulu_c3_num', 'div', 'Vizyon'],
    ['ulu_c3_h', 'h3', 'Ölçeklenebilir İş Geliştirme'],
    ['ulu_c3_p', 'p', 'Çelik sistem, konut ve proje geliştirme başlıklarında kurumsal iş modeli.'],
  ],
};
